...
<html>
  ...
  <body>
    ...
    <p>
         <?php
          echo '｢Appleが5個あります。Orangeは1個しかありません。」と完全に一致しているがどうかを正規表現で検索します。<br>';
    ...
    <p>
         <?php
          echo '小文字のアルファベットが含まれているかどうか正規表現で検索します。<br>';
    ...
    <p>
         <?php
          echo '大文字のアルファベットが含まれているかどうか正規表現で検索します。<br>';
    ...
    <p>
         <?php
          echo '数学が含まれているかどうかを正規表現で検索します。<br>';
