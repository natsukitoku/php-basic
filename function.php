 ...
 <body>
  ...
  <p>
       <?php
        ...
        // 与えられた引数$priceと$shipping_feeを加算し、その値を出力する関数を定義する
  ...
  <p>
      ...
      function type_hinting_retutn_value($num): int {
        return $num * 2;
      }

      // 型宣言と異なるデータ型の戻り値を返す(PHPファイルの先頭にdeclare(strict_type=1);を記述しているのでエラーが発生する)
      echo type_hinting_retutn_value(1);
     ?>
  </p>
 </body>