<!DOCTYPE html>
 ...
 <body>
  ...
  <p>
        <?php
         echo '改行以外の1回以上繰り返されている(1文字以上の)文字が含まれているかどうか正規表現で検索し、検索結果を配列に代入します。<br>';
  ...
  <p>
       <?php
        echo '｢あ」で始まって｢り」で終わる文字列と完全に一致しているかどうか正規表現で検索します。<br>';
  ...
  <p>
       <?php
       echo 'メールアドレスのフォーマットと完全に一致しているかどうか正規表現で検索します。';
